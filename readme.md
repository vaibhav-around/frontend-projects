...
I use a monorepo structure to manage multiple projects efficiently. Each folder is a standalone application.
...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/your-username/portfolio-collection.git](https://github.com/your-username/portfolio-collection.git)

```

2. **Navigate to a project folder:**
```bash
cd project1-html-css
